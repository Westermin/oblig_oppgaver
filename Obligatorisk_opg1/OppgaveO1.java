...
public class OppgaveO1 {
    public static void main(String[] args) {
        ...
        else if (input > 164100 && input <= 230950) input *= 0.0093;   // 0,93%
        else if (input > 230950 && input <=580650)  input *= 0.0241;   // 2,41%
        else if (input > 580650 && input <=934050)  input *= 0.01152;  // 11,52%
        else if (input >=934050)                    input *= 0.01452;  // 14,52%
